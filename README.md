...
# CDKTF prebuilt bindings for PagerDuty/pagerduty provider version 3.27.0

This repo builds and publishes the [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.27.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
- [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.27.0)
