...
# CDKTF prebuilt bindings for PagerDuty/pagerduty provider version 3.23.1

This repo builds and publishes the [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.23.1/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
- [Terraform pagerduty provider](https://registry.terraform.io/providers/PagerDuty/pagerduty/3.23.1)
