...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.27.2/docs/data-sources/event_orchestration_global_cache_variable
...
export class DataPagerdutyEventOrchestrationGlobalCacheVariable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEventOrchestrationGlobalCacheVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.27.2/docs/data-sources/event_orchestration_global_cache_variable#import import section} in the documentation of this resource for the id to use
