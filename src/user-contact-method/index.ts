// https://registry.terraform.io/providers/pagerduty/pagerduty/3.25.2/docs/resources/user_contact_method
...
export class UserContactMethod extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserContactMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.25.2/docs/resources/user_contact_method#import import section} in the documentation of this resource for the id to use
