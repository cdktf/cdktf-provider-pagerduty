// https://registry.terraform.io/providers/pagerduty/pagerduty/3.21.0/docs/resources/slack_connection
...
export class SlackConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlackConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.21.0/docs/resources/slack_connection#import import section} in the documentation of this resource for the id to use
