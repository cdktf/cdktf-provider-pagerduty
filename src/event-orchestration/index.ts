...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.27.0/docs/resources/event_orchestration
...
export class EventOrchestration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventOrchestration that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.27.0/docs/resources/event_orchestration#import import section} in the documentation of this resource for the id to use
