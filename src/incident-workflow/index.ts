// https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.2/docs/resources/incident_workflow
...
export class IncidentWorkflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.2/docs/resources/incident_workflow#import import section} in the documentation of this resource for the id to use
