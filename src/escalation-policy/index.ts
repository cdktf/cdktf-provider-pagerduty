// https://registry.terraform.io/providers/pagerduty/pagerduty/3.3.1/docs/resources/escalation_policy
...
export class EscalationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EscalationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.3.1/docs/resources/escalation_policy#import import section} in the documentation of this resource for the id to use
