...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.1/docs/resources/tag_assignment
...
export class TagAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.1/docs/resources/tag_assignment#import import section} in the documentation of this resource for the id to use
