// https://www.terraform.io/docs/providers/pagerduty/d/licenses
...
export class DataPagerdutyLicenses extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/pagerduty/d/licenses pagerduty_licenses} Data Source
  *
