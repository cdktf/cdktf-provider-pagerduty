...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.1/docs/data-sources/licenses
...
export interface DataPagerdutyLicensesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.1/docs/data-sources/licenses#id DataPagerdutyLicenses#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.1/docs/data-sources/licenses pagerduty_licenses}
*/
export class DataPagerdutyLicenses extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyLicenses that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.1/docs/data-sources/licenses#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.17.1/docs/data-sources/licenses pagerduty_licenses} Data Source
  *
  * @param scope The scope in which to define this construct
