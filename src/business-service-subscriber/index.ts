...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.21.0/docs/resources/business_service_subscriber
...
export class BusinessServiceSubscriber extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BusinessServiceSubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.21.0/docs/resources/business_service_subscriber#import import section} in the documentation of this resource for the id to use
