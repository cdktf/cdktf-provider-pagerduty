// https://registry.terraform.io/providers/pagerduty/pagerduty/3.3.1/docs/resources/automation_actions_runner
...
export class AutomationActionsRunner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationActionsRunner that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.3.1/docs/resources/automation_actions_runner#import import section} in the documentation of this resource for the id to use
