...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.5/docs/data-sources/standards_resource_scores
...
export class DataPagerdutyStandardsResourceScores extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyStandardsResourceScores that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.5/docs/data-sources/standards_resource_scores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.5/docs/data-sources/standards_resource_scores pagerduty_standards_resource_scores} Data Source
  *
  * @param scope The scope in which to define this construct
