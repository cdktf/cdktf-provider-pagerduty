...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.4/docs/resources/service_custom_field_value
...
export class ServiceCustomFieldValue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceCustomFieldValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.4/docs/resources/service_custom_field_value#import import section} in the documentation of this resource for the id to use
