...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.1/docs/resources/incident_custom_field_option
...
export class IncidentCustomFieldOption extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentCustomFieldOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.1/docs/resources/incident_custom_field_option#import import section} in the documentation of this resource for the id to use
