// https://registry.terraform.io/providers/pagerduty/pagerduty/3.5.1/docs
...
export class PagerdutyProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PagerdutyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.5.1/docs#import import section} in the documentation of this resource for the id to use
