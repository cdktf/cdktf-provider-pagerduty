// https://registry.terraform.io/providers/pagerduty/pagerduty/3.2.1/docs/data-sources/extension_schema
...
export class DataPagerdutyExtensionSchema extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyExtensionSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.2.1/docs/data-sources/extension_schema#import import section} in the documentation of this resource for the id to use
