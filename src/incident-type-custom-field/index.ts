...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.21.0/docs/resources/incident_type_custom_field
...
export class IncidentTypeCustomField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentTypeCustomField that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.21.0/docs/resources/incident_type_custom_field#import import section} in the documentation of this resource for the id to use
