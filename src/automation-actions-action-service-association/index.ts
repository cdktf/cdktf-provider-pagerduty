...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.2/docs/resources/automation_actions_action_service_association
...
export class AutomationActionsActionServiceAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationActionsActionServiceAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.2/docs/resources/automation_actions_action_service_association#import import section} in the documentation of this resource for the id to use
