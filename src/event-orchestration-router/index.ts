...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.2/docs/resources/event_orchestration_router
...
export class EventOrchestrationRouter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventOrchestrationRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.15.2/docs/resources/event_orchestration_router#import import section} in the documentation of this resource for the id to use
