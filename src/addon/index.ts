...
// https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.1/docs/resources/addon
...
export class Addon extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Addon that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.10.1/docs/resources/addon#import import section} in the documentation of this resource for the id to use
