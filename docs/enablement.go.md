...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/enablement"
...
| <code><a href="#@cdktf/provider-pagerduty.enablement.EnablementConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.8/docs/resources/enablement#enabled Enablement#enabled}. |
