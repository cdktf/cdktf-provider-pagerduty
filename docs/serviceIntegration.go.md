...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5/serviceintegration"
...
&serviceintegration.ServiceIntegrationEmailParser {
	Action: *string,
	MatchPredicate: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5.serviceIntegration.ServiceIntegrationEmailParserMatchPredicate,
