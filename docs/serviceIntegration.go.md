...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v7/serviceintegration"
...
&serviceintegration.ServiceIntegrationEmailParser {
	Action: *string,
	MatchPredicate: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v7.serviceIntegration.ServiceIntegrationEmailParserMatchPredicate,
