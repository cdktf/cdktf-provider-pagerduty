...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v8/serviceintegration"
...
&serviceintegration.ServiceIntegrationEmailParser {
	Action: *string,
	MatchPredicate: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v8.serviceIntegration.ServiceIntegrationEmailParserMatchPredicate,
