...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v12/datapagerdutyteammembers"
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyTeamMembers.DataPagerdutyTeamMembersConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.4.0/docs/data-sources/team_members#id DataPagerdutyTeamMembers#id}. |
