...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5/servicedependency"
...
&servicedependency.ServiceDependencyConfig {
	...
	Dependency: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5.serviceDependency.ServiceDependencyDependency,
	Id: *string,
}
```
