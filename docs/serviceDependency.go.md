...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v7/servicedependency"
...
```go
func PutDependency(value ServiceDependencyDependency)
```
...
| <code><a href="#@cdktf/provider-pagerduty.serviceDependency.ServiceDependency.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
```go
func Dependency() ServiceDependencyDependencyOutputReference
```
...
```go
func DependencyInput() ServiceDependencyDependency
```
...
&servicedependency.ServiceDependencyConfig {
	...
	Dependency: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v7.serviceDependency.ServiceDependencyDependency,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-pagerduty.serviceDependency.ServiceDependencyConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
```go
func InternalValue() ServiceDependencyDependency
```
