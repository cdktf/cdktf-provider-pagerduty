...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v10/servicedependency"
...
&servicedependency.ServiceDependencyConfig {
	...
	Dependency: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v10.serviceDependency.ServiceDependencyDependency,
	Id: *string,
}
```
