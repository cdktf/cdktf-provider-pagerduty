...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v6/servicedependency"
...
&servicedependency.ServiceDependencyConfig {
	...
	Dependency: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v6.serviceDependency.ServiceDependencyDependency,
	Id: *string,
}
```
