...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5/rulesetrule"
...
&rulesetrule.RulesetRuleConfig {
	...
	Ruleset: *string,
	Actions: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5.rulesetRule.RulesetRuleActions,
	CatchAll: interface{},
	Conditions: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5.rulesetRule.RulesetRuleConditions,
	Disabled: interface{},
	Id: *string,
	Position: *f64,
	TimeFrame: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v5.rulesetRule.RulesetRuleTimeFrame,
	Variable: interface{},
}
```
