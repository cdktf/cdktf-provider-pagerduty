...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v6/automationactionsaction"
...
&automationactionsaction.AutomationActionsActionConfig {
	...
	ActionDataReference: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v6.automationActionsAction.AutomationActionsActionActionDataReference,
	ActionType: *string,
	Name: *string,
