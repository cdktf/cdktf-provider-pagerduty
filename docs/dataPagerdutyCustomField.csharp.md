...
Refer to the Terraform Registory for docs: [`data_pagerduty_custom_field`](https://registry.terraform.io/providers/pagerduty/pagerduty/2.14.5/docs/data-sources/custom_field).
...
Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/2.14.5/docs/data-sources/custom_field pagerduty_custom_field}.
...
new DataPagerdutyCustomField(Construct Scope, string Id, DataPagerdutyCustomFieldConfig Config);
```
...
DataPagerdutyCustomField.IsConstruct(object X);
```
...
DataPagerdutyCustomField.IsTerraformElement(object X);
```
...
DataPagerdutyCustomField.IsTerraformDataSource(object X);
```
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.fixedOptions">FixedOptions</a></code> | <code>HashiCorp.Cdktf.IResolvable</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomField.property.multiValue">MultiValue</a></code> | <code>HashiCorp.Cdktf.IResolvable</code> | *No description.* |
...
```csharp
public IResolvable FixedOptions { get; }
```
...
```csharp
public IResolvable MultiValue { get; }
```
...
new DataPagerdutyCustomFieldConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomFieldConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomFieldConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomFieldConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomFieldConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomFieldConfig.property.name">Name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/2.14.5/docs/data-sources/custom_field#name DataPagerdutyCustomField#name}. |
| <code><a href="#@cdktf/provider-pagerduty.dataPagerdutyCustomField.DataPagerdutyCustomFieldConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/2.14.5/docs/data-sources/custom_field#id DataPagerdutyCustomField#id}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/2.14.5/docs/data-sources/custom_field#name DataPagerdutyCustomField#name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/2.14.5/docs/data-sources/custom_field#id DataPagerdutyCustomField#id}.
