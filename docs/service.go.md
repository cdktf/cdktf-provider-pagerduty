...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14/service"
...
&service.ServiceAlertGroupingParameters {
	Config: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceAlertGroupingParametersConfig,
	Type: *string,
}
```
...
| <code><a href="#@cdktf/provider-pagerduty.service.ServiceAlertGroupingParametersConfig.property.timeout">Timeout</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.8/docs/resources/service#timeout Service#timeout}. |
| <code><a href="#@cdktf/provider-pagerduty.service.ServiceAlertGroupingParametersConfig.property.timeWindow">TimeWindow</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.8/docs/resources/service#time_window Service#time_window}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-pagerduty.service.ServiceAutoPauseNotificationsParameters.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.8/docs/resources/service#enabled Service#enabled}. |
| <code><a href="#@cdktf/provider-pagerduty.service.ServiceAutoPauseNotificationsParameters.property.timeout">Timeout</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.8/docs/resources/service#timeout Service#timeout}. |
...
&service.ServiceConfig {
	...
	AlertGroupingParameters: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceAlertGroupingParameters,
	AlertGroupingTimeout: *string,
	AutoPauseNotificationsParameters: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceAutoPauseNotificationsParameters,
	AutoResolveTimeout: *string,
	Description: *string,
	Id: *string,
	IncidentUrgencyRule: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceIncidentUrgencyRule,
	ResponsePlay: *string,
	ScheduledActions: interface{},
	SupportHours: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceSupportHours,
}
```
...
&service.ServiceIncidentUrgencyRule {
	Type: *string,
	DuringSupportHours: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceIncidentUrgencyRuleDuringSupportHours,
	OutsideSupportHours: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v14.service.ServiceIncidentUrgencyRuleOutsideSupportHours,
	Urgency: *string,
}
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-pagerduty.service.ServiceSupportHours.property.daysOfWeek">DaysOfWeek</a></code> | <code>*[]*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.8/docs/resources/service#days_of_week Service#days_of_week}. |
