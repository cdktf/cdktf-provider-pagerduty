...
```go
import "github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v8/ruleset"
...
&ruleset.RulesetConfig {
	...
	Name: *string,
	Id: *string,
	Team: github.com/cdktf/cdktf-provider-pagerduty-go/pagerduty/v8.ruleset.RulesetTeam,
}
```
